raise ImportError(
    "app.slices.aerobic_pipeline is DEPRECATED and has broken imports. "
    "Use app.slices.cardiorespiratory.orchestrator for the 6-state pipeline. "
    "This file is kept for historical reference only — do not import it."
)

"""
app/slices/aerobic_pipeline.py  [DEPRECATED — DO NOT IMPORT]
