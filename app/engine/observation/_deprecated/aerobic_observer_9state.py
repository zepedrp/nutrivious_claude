"""
app/engine/observation/aerobic_observer.py  [DEPRECATED]

This module is the 9-state observer for the old aerobic pipeline
(app/slices/aerobic_pipeline.py), which is no longer active.
The 6-state pipeline uses app/slices/cardiorespiratory/observation.py instead.
Kept for historical reference only. Nothing in the active pipeline imports this.
